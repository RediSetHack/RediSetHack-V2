...
export class UpdateRegionController {
  ...
  @Patch(":id") @AdminOnly()
  async handle(@Param("id", ParseIntPipe) id: number, @Body() dto: UpdateRegionRequestDto) {
    try {
      return RegionPresenter.toResponse(await this.updateRegion.execute(id, dto));
    } catch (error) {
      asNotFound(error);
    }
  }
...
export class DeleteRegionController {
  ...
  @Delete(":id") @HttpCode(204) @AdminOnly()
  async handle(@Param("id", ParseIntPipe) id: number) {
    try {
...
export class UpdateZoneController {
  ...
  @Patch(":id") @AdminOnly()
  async handle(@Param("id", ParseIntPipe) id: number, @Body() dto: UpdateZoneRequestDto) {
    try {
...
export class UpdateStageController {
  ...
  @Patch(":id") @AdminOnly()
  async handle(@Param("id", ParseIntPipe) id: number, @Body() dto: UpdateStageRequestDto) {
    try {
...
export class UpdateQuestController {
  ...
  @Patch(":id") @AdminOnly()
  async handle(@Param("id", ParseIntPipe) id: number, @Body() dto: UpdateQuestRequestDto) {
    try {
...
export class CreateBadgeDefinitionController {
  ...
  async handle(@Body() dto: CreateBadgeDefinitionRequestDto) {
    return BadgeDefinitionPresenter.toResponse(await this.createBadge.execute(dto));
  }
}
...
export class GetBadgeDefinitionController {
  ...
  async handle(@Param("id", ParseIntPipe) id: number) {
    try {
      return BadgeDefinitionPresenter.toResponse(await this.getBadge.execute(id));
    } catch (error) {
      asNotFound(error);
    }
  }
...
export class UpdateBadgeDefinitionController {
  ...
  @Patch(":id") @AdminOnly()
  async handle(@Param("id", ParseIntPipe) id: number, @Body() dto: UpdateBadgeDefinitionRequestDto) {
    try {
      return BadgeDefinitionPresenter.toResponse(await this.updateBadge.execute(id, dto));
    } catch (error) {
      asNotFound(error);
    }
  }
...
export class CreateCharacterController {
  ...
  async handle(@Body() dto: CreateCharacterRequestDto) {
    return CharacterPresenter.toResponse(await this.createCharacter.execute(dto));
  }
}
...
export class UpdateCharacterController {
  ...
  @Patch(":id") @AdminOnly()
  async handle(@Param("id", ParseIntPipe) id: number, @Body() dto: UpdateCharacterRequestDto) {
    try {
      return CharacterPresenter.toResponse(await this.updateCharacter.execute(id, dto));
    } catch (error) {
      asNotFound(error);
    }
  }
